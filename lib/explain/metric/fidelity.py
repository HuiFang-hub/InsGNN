...
from lib.explain import Explainer, Explanation
from lib.explain.config import ExplanationType, ModelMode
...
def fidelity(
    ...
    :class:`~lib.explain.Explainer` given an
    :class:`~lib.explain.Explanation`, as described in the
