...
from lib.explain import ExplainerConfig, Explanation, ModelConfig
from lib.explain.algorithm import ExplainerAlgorithm
from lib.explain.algorithm.utils import clear_masks, set_masks
from lib.explain.config import MaskType, ModelMode, ModelTaskLevel
...
class GNNExplainer(ExplainerAlgorithm):
    ...
    Args:
        ...
        **kwargs (optional): Additional hyper-parameters to override default
            settings in
            :attr:`~lib.explain.algorithm.GNNExplainer.coeffs`.
    """
    ...
    def __init__(self,aux_info, device,epochs: int = 100, lr: float = 0.01, **kwargs):
        super().__init__()
        self.epochs = epochs
        self.lr = lr
    ...
    def forward(
        ...
        **kwargs,
        ...
        loss = self._train(model, x, edge_index, batch=batch, edge_attr=edge_attr, target=target, index=index, **kwargs)
    ...
    def _train(
        ...
        **kwargs,
        ...
        for i in range(self.epochs ):
            ...
            y_hat, y = model(h, edge_index,batch=batch, edge_attr=edge_attr, **kwargs), target
