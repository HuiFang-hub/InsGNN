...
class PGExplainer(ExplainerAlgorithm):
    ...
    Args:
        ...
        **kwargs (optional): Additional hyper-parameters to override default
            settings in
            :attr:`~lib.explain.algorithm.PGExplainer.coeffs`.
    """
    ...
    def __init__(self,aux_info, device, epochs: int, lr: float = 0.003,  **kwargs):
        super().__init__()
        self.epochs = epochs
        self.lr = lr
    ...
    def train(self,
        ...
        **kwargs,
        ...
        z = get_embeddings(model, x, edge_index, batch=batch, edge_attr=edge_attr,**kwargs)[-1]
        ...
        y_hat, y = model(x, edge_index,batch=batch, edge_attr=edge_attr, **kwargs), target
    ...
    def forward(
        ...
        **kwargs,
        ...
        z = get_embeddings(model, x, edge_index,bacth,edge_attr, **kwargs)[-1]
